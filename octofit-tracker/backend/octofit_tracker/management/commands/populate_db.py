...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Activities
        Activity.objects.create(user='Iron Man', type='Running', duration=30, date='2026-03-01')
        Activity.objects.create(user='Captain America', type='Cycling', duration=45, date='2026-03-01')
        Activity.objects.create(user='Batman', type='Swimming', duration=60, date='2026-03-01')
        Activity.objects.create(user='Superman', type='Flying', duration=120, date='2026-03-01')
